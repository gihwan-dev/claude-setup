...
description: Handles repeated HyperAgent instruction pattern: 반복 지시가 있었지만 스킬 없이 수행된 작업
---

# unknown-proposal

Use when a session matches `반복 지시가 있었지만 스킬 없이 수행된 작업`.
...
## Evidence Sessions
- 019de0d7-b391-7c93-ba3e-46e9550d307b
