...
- styling stack, component source, Storybook/screenshot tooling, token source path, `AGENTS.md` do/don't only를 잠그되 UX ownership은 `UX_SPEC.md`/`UX_BEHAVIOR_ACCESSIBILITY.md`에 남겼는가?
